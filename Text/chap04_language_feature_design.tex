...
\begin{enumerate}
  \item The usage should be intentional for a user
...
This use case already has the \text{var} syntax and reminds the secondary ability of the \texttt{var} keyword representing an inferred type of the declared variable. 
...
\subsubsection{Nothing or Whitespaces Separated by Commas} 
