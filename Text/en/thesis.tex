...
\usepackage{framed}			% algorithms
\usepackage[font=small,skip=2pt]{caption}	% captions
...
\include{preface}
\include{chap01_related_work}
\include{chap02_problem_analysis}
\include{chap03_solution}
\include{chap04_evaluation}
\include{chap05_future_improvements}
