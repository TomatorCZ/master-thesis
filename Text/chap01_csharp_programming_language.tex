...
\end{figure}
\par
The method type inference algorithm is detailly described in a separate section since it is a complex algorithm, and the proposed improvement will be based on that.
...
\section{Method type inference algorithm}
