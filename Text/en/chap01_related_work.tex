...
There exist several algorithms for inferring the most general type of expression. We show the W algorithm in schema \ref{alg05:w} since it is closely related to C\# and Rust type inference.
