...
\def\Dedication{%
I would like to give my thanks to my supervisor, Mgr. Pavel Ježek, Ph.D., and consultant, Rikki Gibson, for their time and advice. 
I would like also to thank my girlfriend, Monika, for her support during writing this thesis.
}
...
\include{preface}
\include{chap01_csharp_programming_language}
\include{chap02_related_work}
\include{chap03_problem_analysis}
\include{chap04_language_feature_design}
\include{chap05_solution}
\include{chap06_evaluation}
\include{chap07_future_improvements}
