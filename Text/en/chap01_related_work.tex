...
\par
\change{Restriction and possible extensions, subtyping, overloading, recursive definition}
H-M type system, as we presented, doesn't allow recursive definitions, subtyping known from Rust or overloading known from C\#.  
