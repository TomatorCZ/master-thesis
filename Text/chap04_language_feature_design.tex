...
\subsection{New Definitions} \label{sect:dependencies}
...
\subsection{Algorithm Phases} \label{sect:phasesAlg}
...
\subsection{Collecting Type Bounds} \label{sect:Collection}
...
\subsection{Fixation} \label{final:fixation}
...
\par
Kotlin divides the method compilation into two groups, as it is described in the video \cite{online:kotlinCompiler} regarding Kotlin compiler architecture. 
