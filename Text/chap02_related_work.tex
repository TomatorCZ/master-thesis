...
This chapter follows by mentioning related work regarding C\# type inference and formalizing it using Hindley-Milner type inference, which is explored in more detail with references to its modification in Rust and C\# programming languages.
