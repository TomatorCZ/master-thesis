...
This section mentions the most relevant whose internals are then considered in the following chapters regarding the design of the improvement.
...
However, this section mentions only those that will be related to our improvement described in the following chapters.
...
\subsection{Method type inference}
